...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    // Synchronously check login state
    ...
    // Asynchronously check login state
...
+ (UIViewController *)getMainController {
    ...
    homeVc.tabBarItem.title = QLS(@"tab_home");
    ...
    groupVc.tabBarItem.title = QLS(@"tab_common");
    ...
    myVc.tabBarItem.title = QLS(@"tab_mine");
